                    ...
                    <table class="table table-bordered table-striped table-sm">
                        ...
                        <tbody>
                            <tr v-for="alumno in arrayAlumno" :key="alumno.id">
                                ...
                                <td v-text="alumno.semestre"></td>
                                <td>
                                    <div v-if="alumno.semestre>7" >
                        ...
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <span class="help-block">(*) Ingrese el nombre del alumno</span>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 form-control-label" for="email-input">Descripción</label>
                                <div class="col-md-9">
                                    <input type="email" v-model="semestre" class="form-control" placeholder="Ingrese Semestre">
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <div class="modal fade" id="modalEliminar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-danger" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Estas seguro de eliminar la alumno?</p>
                    </div>
                    <div class="modal-footer">
